        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                if len(points) != 0:
                    ...
                    ## Stand by Mode - Checking when the index and the pinky fingers are open and don't draw
                    ...
                    if all(fingers[i] == j for i, j in zip(range(0, 5), selecting)) or all(fingers[i] == j for i, j in zip(range(0, 5), setting)):
                        ...
                        # Draw the circle that represents the draw thickness in (x0, y0) and orthogonal
                        # translated c units
                        c = 3 + r
